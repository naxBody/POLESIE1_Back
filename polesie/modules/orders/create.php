                        ...
                        <div class="card-body">
                            ...
                            <div style="padding: 8px 0;">
                                <button type="button" onclick="addItem()" 
                                        ...
                                        style="background: transparent; border: 1px dashed #d1d5db; border-radius: 50%; width: 28px; height: 28px; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; transition: all 0.2s; color: #9ca3af;"
                                        onmouseover="this.style.background='#eff6ff'; this.style.borderColor='#3b82f6'; this.style.color='#3b82f6'"
                                        onmouseout="this.style.background='transparent'; this.style.borderColor='#d1d5db'; this.style.color='#9ca3af'">
