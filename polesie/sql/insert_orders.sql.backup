-- ============================================
-- ЗAКAЗЫ И ПРОИЗBОДCТBEННЫE ЗAДAНИЯ
...
-- ============================================
-- ПОЛУЧEНИE ID ПРОДУКТОB (для использования в INSERT)
-- ============================================
...
SET @p_AIR90LB2 := (SELECT id FROM products WHERE article = 'AIR90LВ2');
SET @p_AIR90L4 := (SELECT id FROM products WHERE article = 'AIR90L4');
SET @p_AIR90LB4 := (SELECT id FROM products WHERE article = 'AIR90LВ4');
SET @p_AIR90L6 := (SELECT id FROM products WHERE article = 'AIR90L6');
SET @p_AIR90LA8 := (SELECT id FROM products WHERE article = 'AIR90LА8');
SET @p_AIR90LB8 := (SELECT id FROM products WHERE article = 'AIR90LВ8');
...
SET @p_AIR112MA6 := (SELECT id FROM products WHERE article = 'AIR112MА6');
SET @p_AIR112MB6 := (SELECT id FROM products WHERE article = 'AIR112MВ6');
SET @p_AIR112MA8 := (SELECT id FROM products WHERE article = 'AIR112MА8');
SET @p_AIR112MB8 := (SELECT id FROM products WHERE article = 'AIR112MВ8');
...
SET @p_AИBР80 := (SELECT id FROM products WHERE article = 'АИВР80');
SET @p_AИBР90L := (SELECT id FROM products WHERE article = 'АИВР90L');
SET @p_BC := (SELECT id FROM products WHERE article = 'BC-0.5-20-U1.1');
SET @p_GNOM := (SELECT id FROM products WHERE article = 'GNOM-10-10');
SET @p_EKCH := (SELECT id FROM products WHERE article = 'EKCH-145');
SET @p_AI\xd0\xa180A2 := (SELECT id FROM products WHERE article = 'AI\xd0\xa180A2');
SET @p_AI\xd0\xa180B2 := (SELECT id FROM products WHERE article = 'AI\xd0\xa180B2');
SET @p_AI\xd0\xa190L2 := (SELECT id FROM products WHERE article = 'AI\xd0\xa190L2');
SET @p_AI\xd0\xa1100S2 := (SELECT id FROM products WHERE article = 'AI\xd0\xa1100S2');
SET @p_AIR80\xd0\x902\xd0\x96 := (SELECT id FROM products WHERE article = 'AIR80\xd0\x902\xd0\x96');
SET @p_AIR90L2\xd0\x96 := (SELECT id FROM products WHERE article = 'AIR90L2\xd0\x96');
SET @p_AI\xd0\x9571A2 := (SELECT id FROM products WHERE article = 'AI\xd0\x9571A2');
SET @p_AI\xd0\x9571B2 := (SELECT id FROM products WHERE article = 'AI\xd0\x9571B2');
...
(1, @p_AIR80A2, 10, 385.70, 3857.00, 'in_progress'),
(1, @p_AIR80B2, 5, 388.36, 1941.80, 'in_progress'),
...
(2, @p_AIR71A4, 10, 276.51, 2765.10, 'not_started'),
(2, @p_AIR71B4, 5, 277.06, 1385.30, 'not_started');
...
INSERT INTO `order_items` (`order_id`, `product_id`, `quantity`, `price`, `total`, `production_status`) VALUES
(4, @p_AIR80A4, 15, 353.85, 5307.75, 'packed'),
(4, @p_AIR80B4, 10, 355.25, 3552.50, 'packed'),
...
(5, @p_AИBР80, 20, 277.75, 5555.00, 'packed'),
(5, @p_AИBР90L, 15, 277.75, 4166.25, 'packed'),
(5, @p_2AIR80A2, 20, 284.20, 5684.00, 'packed'),
(5, @p_2AIR90L2, 15, 288.40, 4326.00, 'packed');

-- Заказ ORD-2025-006 (особые требования)
INSERT INTO `order_items` (`order_id`, `product_id`, `quantity`, `price`, `total`, `production_status`) VALUES
(6, @p_AI\xd0\xa180A2, 15, 285.32, 4279.80, 'in_progress'),
(6, @p_AI\xd0\xa180B2, 10, 287.00, 2870.00, 'in_progress'),
(6, @p_AI\xd0\xa190L2, 8, 289.80, 2318.40, 'not_started'),
(6, @p_AI\xd0\xa1100S2, 10, 293.44, 2934.40, 'not_started'),
(6, @p_AIR80\xd0\x902\xd0\x96, 20, 284.20, 5684.00, 'not_started'),
(6, @p_AIR90L2\xd0\x96, 15, 288.40, 4326.00, 'not_started');
...
INSERT INTO `order_items` (`order_id`, `product_id`, `quantity`, `price`, `total`, `production_status`) VALUES
(8, @p_AIR71A6, 10, 291.07, 2910.70, 'in_progress'),
(8, @p_AIR71B6, 8, 291.60, 2332.80, 'in_progress'),
(8, @p_AIR80A6, 6, 392.93, 2357.58, 'completed'),
(8, @p_AIR80B6, 5, 394.29, 1971.45, 'packed'),
(8, @p_EKCH, 50, 45.00, 2250.00, 'packed');

-- Заказ ORD-2025-009 (отмененный)
INSERT INTO `order_items` (`order_id`, `product_id`, `quantity`, `price`, `total`, `production_status`) VALUES
(9, @p_AI\xd0\x9571A2, 10, 281.54, 2815.40, 'not_started'),
(9, @p_AI\xd0\x9571B2, 10, 282.10, 2821.00, 'not_started');
...
-- ============================================
-- 3. ПРОИЗBОДCТBEННЫE ЗAДAНИЯ (production_tasks)
-- ============================================
...
('TASK-2025-001', 1, 1, @p_AIR80A2, (SELECT id FROM route_cards WHERE product_id = @p_AIR80A2), 10, 'in_progress', 'high', '2025-01-16', '2025-02-01', '2025-01-16 08:00:00', '2025-02-01 17:00:00', 3, 6, 'Cрочное задание'),
('TASK-2025-002', 1, 2, @p_AIR80B2, NULL, 5, 'in_progress', 'high', '2025-01-17', '2025-02-05', '2025-01-17 08:00:00', '2025-02-05 17:00:00', 3, 6, NULL),
...
('TASK-2025-007', 2, 7, @p_AIR71A4, NULL, 10, 'planned', 'low', NULL, NULL, '2025-02-05 08:00:00', '2025-02-15 17:00:00', 4, NULL, NULL),
('TASK-2025-008', 2, 8, @p_AIR71B4, NULL, 5, 'planned', 'low', NULL, NULL, '2025-02-10 08:00:00', '2025-02-20 17:00:00', 3, NULL, NULL);
...
INSERT INTO `production_tasks` (`task_number`, `order_id`, `order_item_id`, `product_id`, `route_card_id`, `quantity_plan`, `status`, `priority`, `start_date`, `end_date`, `planned_start`, `planned_end`, `responsible_id`, `worker_id`, `notes`) VALUES
('TASK-2025-014', 4, 14, @p_AIR80A4, NULL, 15, 'completed', 'normal', '2025-01-06', '2025-01-20', '2025-01-06 08:00:00', '2025-01-20 17:00:00', 3, 6, 'Упаковано'),
('TASK-2025-015', 4, 15, @p_AIR80B4, NULL, 10, 'completed', 'normal', '2025-01-07', '2025-01-22', '2025-01-07 08:00:00', '2025-01-22 17:00:00', 4, 6, 'Упаковано'),
...
('TASK-2025-020', 5, 20, @p_AИBР80, NULL, 20, 'completed', 'normal', '2024-12-23', '2025-01-08', '2024-12-23 08:00:00', '2025-01-08 17:00:00', 3, 6, 'Отгружено'),
('TASK-2025-021', 5, 21, @p_AИBР90L, NULL, 15, 'completed', 'normal', '2024-12-24', '2025-01-09', '2024-12-24 08:00:00', '2025-01-09 17:00:00', 4, 6, 'Отгружено'),
...
INSERT INTO `production_tasks` (`task_number`, `order_id`, `order_item_id`, `product_id`, `route_card_id`, `quantity_plan`, `status`, `priority`, `start_date`, `end_date`, `planned_start`, `planned_end`, `responsible_id`, `worker_id`, `notes`) VALUES
('TASK-2025-024', 6, 24, @p_AI\xd0\xa180A2, NULL, 15, 'in_progress', 'high', '2025-01-26', '2025-02-15', '2025-01-26 08:00:00', '2025-02-15 17:00:00', 3, 6, 'Особые требования'),
('TASK-2025-025', 6, 25, @p_AI\xd0\xa180B2, NULL, 10, 'in_progress', 'high', '2025-01-27', '2025-02-16', '2025-01-27 08:00:00', '2025-02-16 17:00:00', 4, 6, NULL),
('TASK-2025-026', 6, 26, @p_AI\xd0\xa190L2, NULL, 8, 'planned', 'normal', NULL, NULL, '2025-02-10 08:00:00', '2025-02-25 17:00:00', 3, NULL, NULL),
('TASK-2025-027', 6, 27, @p_AI\xd0\xa1100S2, NULL, 10, 'planned', 'normal', NULL, NULL, '2025-02-12 08:00:00', '2025-02-28 17:00:00', 4, NULL, NULL),
('TASK-2025-028', 6, 28, @p_AIR80\xd0\x902\xd0\x96, NULL, 20, 'planned', 'normal', NULL, NULL, '2025-02-15 08:00:00', '2025-03-01 17:00:00', 3, NULL, 'Для насосов'),
('TASK-2025-029', 6, 29, @p_AIR90L2\xd0\x96, NULL, 15, 'planned', 'normal', NULL, NULL, '2025-02-18 08:00:00', '2025-03-05 17:00:00', 4, NULL, 'Для насосов');
...
INSERT INTO `production_tasks` (`task_number`, `order_id`, `order_item_id`, `product_id`, `route_card_id`, `quantity_plan`, `status`, `priority`, `start_date`, `end_date`, `planned_start`, `planned_end`, `responsible_id`, `worker_id`, `notes`) VALUES
('TASK-2025-034', 8, 34, @p_AIR71A6, NULL, 10, 'in_progress', 'normal', '2025-01-13', '2025-02-01', '2025-01-13 08:00:00', '2025-02-01 17:00:00', 3, 6, NULL),
('TASK-2025-035', 8, 35, @p_AIR71B6, NULL, 8, 'in_progress', 'normal', '2025-01-14', '2025-02-03', '2025-01-14 08:00:00', '2025-02-03 17:00:00', 4, 6, NULL),
('TASK-2025-036', 8, 36, @p_AIR80A6, NULL, 6, 'completed', 'normal', '2025-01-13', '2025-01-28', '2025-01-13 08:00:00', '2025-01-28 17:00:00', 3, 6, 'Готово'),
('TASK-2025-037', 8, 37, @p_AIR80B6, NULL, 5, 'completed', 'normal', '2025-01-14', '2025-01-29', '2025-01-14 08:00:00', '2025-01-29 17:00:00', 4, 6, 'Упаковано'),
...
INSERT INTO `production_tasks` (`task_number`, `order_id`, `order_item_id`, `product_id`, `route_card_id`, `quantity_plan`, `status`, `priority`, `start_date`, `end_date`, `planned_start`, `planned_end`, `responsible_id`, `worker_id`, `notes`) VALUES
('TASK-2025-039', 9, 39, @p_AI\xd0\x9571A2, NULL, 10, 'cancelled', 'normal', NULL, NULL, '2025-01-15 08:00:00', '2025-01-30 17:00:00', 3, NULL, 'Отменено'),
('TASK-2025-040', 9, 40, @p_AI\xd0\x9571B2, NULL, 10, 'cancelled', 'normal', NULL, NULL, '2025-01-16 08:00:00', '2025-01-31 17:00:00', 4, NULL, 'Отменено');
...
-- ============================================
-- 4. ЭТAПЫ BЫПОЛНEНИЯ ЗAДAНИЙ (production_task_stages)
-- ============================================
...
(1, (SELECT id FROM production_stages WHERE code = 'blank'), 'completed', '2025-01-16 08:00:00', '2025-01-16 12:00:00', 6, 10, 'Раскрой выполнен'),
...
(1, (SELECT id FROM production_stages WHERE code = 'winding'), 'in_progress', '2025-01-20 08:00:00', NULL, 6, 6, 'Намотка в процессе'),
...
-- ============================================
-- 5. МAТEРИAЛЫ ДЛЯ ЗAДAНИЙ (production_tasks_materials)
-- ============================================

-- Материалы для TASK-2025-001 (AIR80A2, 10 шт)
...
-- - Множество этапов выполнения
-- - Материалы для заданий с разным уровнем доступности
-- ============================================
